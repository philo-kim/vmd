...
**Evidence:** Most allowance apps track money, but real family tension usually
appears around responsibility, habits, motivation, and trust.
...
- Define the semantic language
- Build the browser renderer
- Test with investor and education documents
- Add quality checks for claims, evidence, and decisions

**Action:** Start with a small grammar and make the renderer useful before
